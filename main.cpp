...
int main(int argc, char *argv[])
{
    ...
    QTranslator qtTranslator;
           ...
           QString nomFichier="reqBDD_" + QLocale::system().name()+".qm";
           qDebug()<<nomFichier;
           QString baseName;
   //defining paths to translations
   #ifdef Q_OS_LINUX
           baseName="/usr/share/applications/reqBDD/translations/";
   #endif
   #ifdef Q_OS_MACOS
          ...
          myappTranslator.load(baseName+nomFichier);
           //myappTranslator.load("/usr/share/applications/reqBDD/translations/reqBDD_" + QLocale::system().name()+".qm");
